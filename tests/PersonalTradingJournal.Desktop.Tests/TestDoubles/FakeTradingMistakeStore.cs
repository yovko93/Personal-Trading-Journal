...
{
    public TradingMistake? Mistake { get; set; } public Exception? AddException { get; set; } public Exception? GetException { get; set; } public Exception? UpdateException { get; set; }
    public int AddCalls { get; private set; } public int GetCalls { get; private set; } public int UpdateCalls { get; private set; } public Guid RequestedId { get; private set; }
    ...
    { GetCalls++; RequestedId = id; return GetException is null ? Task.FromResult(Mistake) : Task.FromException<TradingMistake?>(GetException); }
