...
public partial class App : System.Windows.Application
{
    ...
    public App()
    {
        ...
        try
        {
            ...
            builder.Services.AddTransient<CreateStrategyUseCase>();
            builder.Services.AddTransient<StrategyLifecycleUseCase>();
            ...
            builder.Services.AddTransient<StrategiesViewModel>();
