...
namespace PersonalTradingJournal.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260923074655_AddTradovateImportPersistence")]
    partial class AddTradovateImportPersistence
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PersonalTradingJournal.Infrastructure.Persistence.Records.TradovateImportedExecutionRecord", b =>
                {
                    ...
                    b.HasIndex("TradingAccountIdAtImport", "BrokerSymbol", "Side", "ExternalExecutionId")
                        .IsUnique();
