...
public sealed class TradingSetupRecordConfiguration :
    IEntityTypeConfiguration<TradingSetupRecord>
{
    public void Configure(EntityTypeBuilder<TradingSetupRecord> builder)
    {
        builder.ToTable("TradingSetups");
